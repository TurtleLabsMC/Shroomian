...
import static net.minecraft.particle.ParticleTypes.DRIPPING_HONEY;
        ...
        if (!world.isClient) {
            ...
            if (player.getInventory().getMainHandStack().isOf(Items.GLASS_BOTTLE) && !isWithered) {
                ...
                if (player.getMainHandStack().isEmpty()) {
                    player.setStackInHand(hand, new ItemStack(ReverieObjects.ELIXIR));
                } else if (!player.getInventory().insertStack(new ItemStack(ReverieObjects.ELIXIR))) {
                    player.dropItem(new ItemStack(ReverieObjects.ELIXIR), false);
                }
